...
public class ValueUtil {
    ...
    public static final String JAVA_MODEL_PREFIX = "com.zdww";
    private static List<String> REC_LOWER_FIELDS = new ArrayList<String>();

    static {
        REC_LOWER_FIELDS.add("createdBy");
        REC_LOWER_FIELDS.add("createdAt");
        REC_LOWER_FIELDS.add("updatedBy");
        REC_LOWER_FIELDS.add("updatedAt");
